...
public class ScriptStackoverflowSpringMVCQuestion {
    public static void main(String []args) throws Exception {
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        File f = new File("src/test/java/com/cs209/project/file/SpringMVCStackoverflowQuestion.txt");
        ...
        try (bw) {
            bw.write(ans);
            for (int q = 3; q < 66; q++) {
                String str = "https://api.stackexchange.com/2.3/tags/spring-mvc/faq?page="+q+"&pagesize=100&site=stackoverflow&key=*Q4hDtZ8bVAQZve4zcfkqw((";
                URL url = new URL(str);
