...
public class ScriptGithubGuiceIssue {
    public static void main(String[] args) throws Exception {
        File f = new File("src/test/java/com/cs209/project/file/GuiceGithubIssue.txt");
        ...
        try (bw) {
            ...
            for (int i = 1; i < 34; i++) {
                ...
                String str = "https://github.com/google/guice/issues?page="+i+"&q=is%3Aissue+is%3Aclosed";
                URL url = new URL(str);
